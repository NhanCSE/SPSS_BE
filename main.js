...
var processError = function (error) {
    var _a;
    return {
        success: (_a = error === null || error === void 0 ? void 0 : error.response) === null || _a === void 0 ? void 0 : _a.data,
...
var SystemConfiguration = /** @class */ (function () {
    ...
    SystemConfiguration.prototype.createSystemConfiguration = function (createInfo, token) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.baseUrl, "/searchAll"), customHeader(token))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, processResponse(response)];
                    case 2:
    ...
    SystemConfiguration.prototype.getNewestSystemConfiguration = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.baseUrl, "/searchNewest"), customHeader(token))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, processResponse(response)];
                    case 2:
...
var PrinterOperation = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post("".concat(this.baseUrl, "/create"), createPrinterInfo, customHeader(token))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, processResponse(response)];
                    case 2:
    ...
    PrinterOperation.prototype.countAll = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.baseUrl, "/count/all"), customHeader(token))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, processResponse(response)];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.baseUrl, "/searchToPrint"), {
                                params: payload,
                                withCredentials: true,
                                headers: {
                                    Authorization: "Bearer ".concat(token)
...
var HistoryOperation = /** @class */ (function () {
    ...
    HistoryOperation.prototype.getPrinterHistory = function (printerId, token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.baseUrl, "/printer/").concat(printerId), customHeader(token))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, processResponse(response)];
                    case 2:
...
var User = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.baseUrl, "/search/").concat(student_id), customHeader(token))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, processResponse(response)];
                    case 2:
    ...
    User.prototype.countUser = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.baseUrl, "/count"), customHeader(token))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, processResponse(response)];
                    case 2:
    ...
    User.prototype.countAdmin = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.baseUrl, "/admin/count"), customHeader(token))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, processResponse(response)];
                    case 2:
    ...
    User.prototype.countStudent = function (token) {
        return __awaiter(this, void 0, void 0, function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.get("".concat(this.baseUrl, "/search/student/").concat(studentId), customHeader(token))];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, processResponse(response)];
                    case 2:
                        error_31 = _a.sent();
                        processError(error_31);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1.default.post("".concat(this.baseUrl, "/signup"), createInfo)];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, processResponse(response)];
                    case 2:
                        error_33 = _a.sent();
                        processError(error_33);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
