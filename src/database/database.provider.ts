...
export const databaseProviders = [
  {
    ...
    useFactory: async () => {
      ...
      sequelize.addModels([PrinterError, Printer, Location, Admin, Student, User, ErrorHistory, PrintingHistory, SysConfigHistory, SystemConfiguration, GeneralPaperReport, PaymentTrasaction, File, Payment]);
