...
import { GeneralPaperReport,PaymentReport } from "src/modules/report/entities/report.entity";
...
export const databaseProviders = [
  {
    ...
    useFactory: async () => {
      ...
      sequelize.addModels([PrinterError, Printer, Location, Admin, Student, User, ErrorHistory, PrintingHistory, SysConfigHistory, SystemConfiguration, GeneralPaperReport, Payment_Trasaction,PaymentReport]);
