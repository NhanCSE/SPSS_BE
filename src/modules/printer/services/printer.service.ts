...
export class PrinterService {
  ...
  async search(searchCriteria: any) {
    try {
      ...
      console.error('Lỗi tìm kiếm máy in:', error);
      throw new Error('Lỗi tìm kiếm máy in');
    }
  }
  ...
  async update(id: string, updatePrinterDto: UpdatePrinterDto) {
    try {
      ...
      console.error('Lỗi cập nhật thông tin máy in:', error);
      throw new Error('Lỗi cập nhật thông tin máy in');
    }
  }
